...
# buildmodel(CatBoostClassifier(depth=8, l2_leaf_reg=10, learning_rate=0.18, num_trees=121), True, False, True)
...
buildmodel(CatBoostClassifier(), False, False, True)
...
# buildmodel(CatBoostClassifier(), True, True, True)
