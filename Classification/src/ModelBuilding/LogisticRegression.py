...
class_weights = {0: 2/3, 1: 1/3}
rf_classifier = LogisticRegression(random_state=90, class_weight=class_weights)
rf_classifier.fit(X_train, y_train)

# You can also calculate and print the average F1 score across all classes
f1_scores = cross_val_score(rf_classifier, X, y, cv=10, scoring='f1_macro')
